        ...
        <>
            <div className="relative p-10">
                <div>
                    ...
                    <p>Last updated: September 22, 2023</p>
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the
                                ...
                                refers to Vezber Technology Private Limited, Krishna Complex, Amosi
                                Industrial Area, Lucknow.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Vezber, accessible from <a href="https://vezber.com"
                                                                                             rel="external nofollow noopener noreferrer"
                                                                                             target="_blank">https://vezber.com</a>
                            </p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>
                            <p>By email: <a href="/cdn-cgi/l/email-protection" className="__cf_email__"
                                            data-cfemail="8bfbf9e2fdeae8f2cbfdeef1e9eef9a5e8e4e6">privacy@vezber.com</a>
                            </p>
                        </li>
                        <li>
                            <p>By visiting this page on our website: <a href="https://vezber.com/contact"
                                                                        rel="external nofollow noopener noreferrer"
                                                                        target="_blank">https://vezber.com/contact</a>
                            </p>
                        </li>
                        <li>
                            <p>By phone number: +91 94038 90690</p>
                        </li>
                    </ul>
                </div>
            </div>
