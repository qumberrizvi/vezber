...
const features = [
  ...
  },
  {
    ...
    description:
      "Jumpstart your next project by deploying Vezber to [Vercel](https://vercel.com/) in one click.",
    demo: (
      <a href={'#'}>
        <Image
  ...
  },
  {
    ...
    description:
      "Vezber comes with authentication and database via [Auth.js](https://authjs.dev/) + [Prisma](https://prisma.io/)",
    demo: (
  ...
  },
  {
    ...
    description:
      "Vezber offers a collection of hooks, utilities, and `@vercel/og`",
    demo: (
